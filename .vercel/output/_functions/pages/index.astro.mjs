...
<\/script>`], ["", '<section id="contact" class="max-w-4xl mx-auto py-20 px-6 text-center"> ', " ", ` </section> <script type="module">
const form = document.querySelector('#contact-form');
const statusEl = form.querySelector('[data-status]');
const btn = form.querySelector('button[type="submit"]');
...
Send Message
</button> <div data-status class="text-sm text-gray-400"></div> </form> ` }));
